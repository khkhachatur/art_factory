        ...
        <Navigation navTo="Studios" navToTo="Apply form" />
          <div className={classNames.mainInfo}>
            ...
            <div className={classNames.discription}>
              <Title text={'About'} />
              <p style={{paddingTop:'70px'}} className={classNames.text}>Art Factory provides a multi-functional space and community to Yerevan-based creatives.</p>
              <p className={classNames.text}>We have a variety of studio spaces available to rent, all equipped with lighting, electricity, a wash closet and a shower.</p>
              <p className={classNames.text}>Our nine studios are home to artists at all stages of their careers, working across all mediums.</p>
              <img style={{paddingTop:'70px'}} src={jobPic} alt="" />
            </div>
          </div>
          <div>
          </div>
