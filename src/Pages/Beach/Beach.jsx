    ...
    <div className={classNames.container}>
      <div className={classNames.section}>
        ...
        <div className={classNames.gallery}>
          <ul className={classNames.galleryList}>
            <li>
              <img src={bf_1} alt="Img" />
            </li>
            <li>
              <img src={bf_2} alt="Img" />
            </li>
            <li>
              <img src={bf_3} alt="Img" />
            </li>
          </ul>
        </div>
        ...
        <div className={classNames.opContainer}>
          ...
          <div className={classNames.opSection}>
            <div className={classNames.opBlock}>
              <img
                className={classNames.opImage}
                src={joinUs}
                alt="subscribeImage"
              />
              <div className={classNames.opDescription}>
                <h3 className={classNames.opTitle}>
                  Join our happy <br /> team
                </h3>
            ...
            <div className={classNames.opBlock}>
              ...
              <div className={classNames.opDescription}>
                <div>
                  <h3 className={classNames.opTitle}>
                    Reserve <br /> photoshooting
                  </h3>
                  <p className={classNames.disc}>
                    {" "}
                    Description of the <br /> place advantages
                  </p>
                  <p className={classNames.contactsItem_2}>
                    {contactCardInfo.tel}
                  </p>
                  <p className={classNames.contactsItem_2}>
                    Address: {contactCardInfo.address}
