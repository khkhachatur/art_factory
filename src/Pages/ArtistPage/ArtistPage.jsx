      ...
      <div className={classNames.section}>
        ...
        <div className={classNames.topContainer}>
          <div className={classNames.artist}>
            ...
            <ul className={classNames.contactList}>
              ...
              <li className={classNames.contactItem}>
                Mail: {artists[0].mail}
              </li>
            </ul>
          </div>
        ...
        <div className={classNames.discription}>
          <ul className={classNames.discriptionText}>
            ...
            <p
              className={classNames.discriptionSubText}
              style={{ margin: "red" }}
            >
              {artists[0].biography}
            </p>
            ...
            <ul className={classNames.discriptionList}>
              <li>
                <p className={classNames.discriptionSubText}>
                  {artists[0].education.education1}
                </p>
              </li>
              <li>
                <p className={classNames.discriptionSubText}>
                  {artists[0].education.education2}
                </p>
              </li>
            </ul>
            ...
            <ul className={classNames.discriptionList}>
              <li>
                <p className={classNames.discriptionSubText_02}>
                  {artists[0].exhibitions.exhibitions1}
                </p>
              </li>
              <li>
                <p className={classNames.discriptionSubText_02}>
                  {artists[0].exhibitions.exhibitions2}
                </p>
              </li>
            </ul>
          </ul>
        ...
        <div className={classNames.articles}>
          ...
          <ul className={classNames.artList}>
            <a
              className={classNames.artLink}
              href={artists[0].articles.articles1}
              rel="noreferrer"
              target="_blank"
            >
              {artists[0].articles.articles1}
            </a>
            <a
              className={classNames.artLink}
              href={artists[0].articles.articles2}
              rel="noreferrer"
              target="_blank"
            >
              {artists[0].articles.articles2}
            </a>
          </ul>
        </div>
